...
for i in range(len(args.splits)):
    ...
    if os.path.exist('results') == False:
        os.mkdir('results')
    if os.path.exist('results/{}'.format(data_set)) == False:
        os.mkdir('results/{}'.format(data_set))
    if os.path.exist('results/{}/NFM/split_{}'.format(data_set, split_index)) == False:
        os.mkdir('results/{}/NFM/split_{}'.format(data_set, split_index))
